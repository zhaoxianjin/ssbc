...
class Master(Thread):
    ...
    def got_torrent(self):
        ...
        if 'files' in info:
            try:
                self.db_execute('INSERT INTO search_filelist VALUES(%s, %s)', (info['info_hash'], json.dumps(info['files'])))
            except:
        ...
        try:
            ...
            ret = self.db_execute('INSERT INTO search_hash(info_hash,category,data_hash,name,extension,classified,source_ip,tagged,' + 
